...
public class ColorDataTableRepositoryImpl extends RepositoryComponent implements DatatableRepository {
	
	@Override
	public long findAllCount(DatatableParameter datatableParameter) {
		String SQL = "SELECT COUNT(b.id) FROM Color b";
	...
	public JSONArray findAllData(DatatableParameter datatableParameter) {
		...
		try{
			...
			String SQL = "SELECT b.* FROM Color b ";
