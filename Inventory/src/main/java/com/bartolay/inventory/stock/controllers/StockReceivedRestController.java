...
public class StockReceivedRestController extends AbstractRestController {
	...
	public String create(@Valid StockReceivedForm stockReceivedForm, BindingResult bindingResult)
		...
		try {
			...
			response = new ApiResponse(HttpStatus.OK,
					"Succesfully created Document " + stockReceived.getDocumentNumber());
		} catch (Exception e) {
			e.printStackTrace();
...
//			throw new RestApiException(e);
	...
	public String apiExpensesList(@RequestParam Map<String, String> requestMap)
	...
	public String createExpense(@Valid ExpenseForm expenseForm, BindingResult bindingResult)
			throws RestApiException, JsonProcessingException, UnsupportedEncodingException {
		if (bindingResult.hasErrors()) {
			return handleRestApiException(bindingResult);
		}
	...
	public String deleteExpense(@PathVariable("id") Integer id)
			throws StockAdjustmentException, JsonProcessingException, UnsupportedEncodingException {
